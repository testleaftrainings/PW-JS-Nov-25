...
var LoginPage = /** @class */ (function () {
    ...
    LoginPage.prototype.loadurl = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.lppage.goto("http://leaftaps.com/opentaps/control/main")]; // await page.goto
                    case 1:
    ...
    LoginPage.prototype.enterCredentials = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.lppage.locator("#username").fill("democsr2")];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.lppage.locator("#password").fill("crmsfa")];
                    case 2:
                        _a.sent();
                        return [4 /*yield*/, this.lppage.waitForTimeout(3000)];
                    case 3:
                        _a.sent();
                        return [2 /*return*/];
                }
    ...
    LoginPage.prototype.clickLogin = function () {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.lppage.locator(".decorativeSubmit").click()];
                    case 1:
                        _a.sent();
                        return [2 /*return*/];
                }
